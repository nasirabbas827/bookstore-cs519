...
<div class="jumbotron text-center">
    ...
    <p>Explore a vast collection of books, discover your next read, and enjoy seamless online shopping</p>
...
<div class="container mt-5">
        ...
        <form method="GET" action="">
            <div class="row">
                <div class="col-md-3 mb-3">
                    <input type="text" class="form-control" placeholder="Search by Book" name="search" value="<?php echo $search_query; ?>">
                </div>
                <div class="col-md-3 mb-3">
                ...
                <div class="col-md-2 mb-3">
                    <input type="text" class="form-control" placeholder="Search by Book name" name="product_name" value="<?php echo $product_name; ?>">
                </div>
  ...
  <div class="container">
    ...
    <div class="row mt-3">
      <div class="col">
        <p class="text-center mb-0">&copy; 2025 Online Book Store Project. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
